---
title: CMud Archer Triggers
permalink: wiki/CMud_Archer_Triggers/
layout: wiki
tags:
 -  Cmud Scripting
---
...
The first part is an auto-[fletch](/wiki/Fletch "wikilink") trigger. Type
**autofletch** to scroll through the options to automatically create
hero or lord level [arrows](/wiki/Category%3AArrows "wikilink") or
[bolts](/wiki/Category%3ABolts "wikilink"). You can specify type (including
poison) and quantity you wish to make. The script will continue
fletching until you make or exceed your goal.

The second part is an [autoheld](/wiki/Held_Shot "wikilink") trigger. Type
**autoheld** to turn the feature on or off. An echo will let you know
your autoheld status.

The third part is a [longshot](/wiki/Longshot "wikilink") script. <u>This is
...
decision to fire.  
<img src="Longshot.jpg" title="fig: | |Longshot Echo Example" alt=" | |Longshot Echo Example" width="600" />

This script will automatically pick up any arrows and bolts on the floor
after a fight. Be sure to have [Autopull](/wiki/Autopull "wikilink") turned
on!

I use this ArcherClass script in conjunction with my
[AmmoCheck](/wiki/CMud_Ammocheck "wikilink") script to keep my ammo counts up
to date.
...
Feel free to note me [here](/wiki/User%3AShalineth "wikilink") or on board 2
