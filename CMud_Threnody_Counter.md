---
title: CMud Threnody Counter
permalink: wiki/CMud_Threnody_Counter/
layout: wiki
tags:
 - Cmud_Scripting
---
...
[Threnody](/wiki/Threnody "wikilink") ritual when you join it, and will
increment every time another [Lord](/wiki/Category%3ALord "wikilink") joins
in. Requires a window to display the values of the variables
"thren\_count" and "lblthren". (I use my Status window).
