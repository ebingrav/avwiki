...
` 99: `  
`101: `[`balance`](Balance "wikilink")`            `[`bladedance`](Bladedance "wikilink")`#        `[`create`` ``food`](Create_Food "wikilink")`        `[`create`` ``spring`](Create_Spring "wikilink")`      `[`create`` ``water`](Create_Water "wikilink")  
`     `[`dervish`` ``dance`](Dervish_Dance "wikilink")`#     `[`fast`` ``healing`` ``ii`](Fast_Healing_II "wikilink")`    `[`improved`` ``stamina`](Improved_Stamina "wikilink")`   `[`inspiring`` ``dance`](Inspiring_Dance "wikilink")`#   `[`meditation`` ``ii`](Meditation_II "wikilink")  
`     `[`quickstrike`](Quickstrike "wikilink")`        `[`tutor`` ``other`](Tutor_Other "wikilink")  
`500: `[`eulogy`](Eulogy "wikilink")`             `[`catch`` ``weapon`](Catch_Weapon "wikilink")`       `[`sublime`` ``strike`](Sublime_Strike "wikilink")`#`  
`675: `[`bladetrance`](Bladetrance "wikilink")`#`  
`800: `[`sublime`` ``flow`](Sublime_Flow "wikilink")`#`  
`     `  
`   # `[`Hero`](:Category:_Hero "wikilink")` skills & spells that `[`Bladedancers`](:Category:_Bladedancers "wikilink")` may learn but `[`Rogues`](:Category:_Rogues "wikilink")` may not.`
...
[Rogue Hero Skills &
Spells](:Category:_Rogue_Hero_Skills_And_Spells "wikilink").
