## Bladedancer Hero Skills & Spells Chart
...
`     `  
`  1: `[`appoint`](Appoint.md "wikilink")`            `[`body`` ``brace`](Body_Brace.md "wikilink")`         `[`butcher`](Butcher.md "wikilink")`            `[`kick`](Kick.md "wikilink")`               `[`meditation`](Meditation.md "wikilink")  
...
`     `[`shadow`` ``form`](Shadow_Form.md "wikilink")`        `[`word`` ``of`` ``recall`](Word_Of_Recall.md "wikilink")  
`  7: `[`curse`](Curse.md "wikilink")`              `[`detect`` ``magic`](Detect_Magic.md "wikilink")`       `[`endurance`](Endurance.md "wikilink")`          `[`forage`](Forage.md "wikilink")`             `[`identify`](Identify_(spell).md "wikilink")  
...
` 19: `[`adrenaline`` ``pump`](Adrenaline_Pump.md "wikilink")`    `[`bashdoor`](Bashdoor.md "wikilink")`           `[`bless`](Bless.md "wikilink")`              `[`dart`](Dart_(spell).md "wikilink")`               `[`dispel`` ``evil`](Dispel_Evil.md "wikilink")  
`     `[`enhanced`` ``damage`](Enhanced_Damage.md "wikilink")`    `[`track`](Track.md "wikilink")  
...
` 25: `[`cure`` ``disease`](Cure_Disease.md "wikilink")`       `[`displacement`](Displacement.md "wikilink")`       `[`double`` ``wield`](Double_Wield.md "wikilink")`       `[`energy`` ``drain`](Energy_Drain.md "wikilink")`       `[`know`` ``alignment`](Know_Alignment.md "wikilink")  
`     `[`shield`](Shield.md "wikilink")  
...
`     `[`third`` ``attack`](Third_Attack.md "wikilink")`       `[`turn`` ``undead`](Turn_Undead.md "wikilink")  
...
` 69: `[`calm`](Calm.md "wikilink")`               `[`fortitudes`](Fortitudes.md "wikilink")`         `[`invigorate`](Invigorate.md "wikilink")`         `[`riposte`](Riposte.md "wikilink")`            `[`seal`](Seal.md "wikilink")  
...
` 77: `  
` 79: `[`bloodhound`](Bloodhound.md "wikilink")`         `[`earthquake`](Earthquake.md "wikilink")`         `[`foci`](Foci.md "wikilink")`               `[`mass`` ``invigorate`](Mass_Invigorate.md "wikilink")`    `[`nexus`](Nexus.md "wikilink")  
`     `[`sandstorm`](Sandstorm.md "wikilink")  
` 81: `  
...
` 99: `  
`101: `[`balance`](Balance.md "wikilink")`            `[`bladedance`](Bladedance.md "wikilink")`#        `[`create`` ``food`](Create_Food.md "wikilink")`        `[`create`` ``spring`](Create_Spring.md "wikilink")`      `[`create`` ``water`](Create_Water.md "wikilink")  
`     `[`dervish`` ``dance`](Dervish_Dance.md "wikilink")`#     `[`fast`` ``healing`` ``ii`](Fast_Healing_II.md "wikilink")`    `[`improved`` ``stamina`](Improved_Stamina.md "wikilink")`   `[`inspiring`` ``dance`](Inspiring_Dance.md "wikilink")`#   `[`meditation`` ``ii`](Meditation_II.md "wikilink")  
`     `[`quickstrike`](Quickstrike.md "wikilink")`        `[`tutor`` ``other`](Tutor_Other.md "wikilink")  
`500: `[`eulogy`](Eulogy.md "wikilink")`             `[`catch`` ``weapon`](Catch_Weapon.md "wikilink")`       `[`sublime`` ``strike`](Sublime_Strike.md "wikilink")`#`  
`675: `[`bladetrance`](Bladetrance.md "wikilink")`#`  
`800: `[`sublime`` ``flow`](Sublime_Flow.md "wikilink")`#`  
`     `  
`   # `[`Hero`](:Category:_Hero.md "wikilink")` skills & spells that `[`Bladedancers`](:Category:_Bladedancers.md "wikilink")` may learn but `[`Rogues`](:Category:_Rogues.md "wikilink")` may not.`

See also [Bladedancer Lowmort Skills &
Spells](:Category:_Bladedancer_Lowmort_Skills_And_Spells.md "wikilink"),
[Black Circle Initiate Hero Skills &
Spells](:Category:_Black_Circle_Initiate_Hero_Skills_And_Spells.md "wikilink"),
[Rogue Hero Skills &
Spells](:Category:_Rogue_Hero_Skills_And_Spells.md "wikilink").
