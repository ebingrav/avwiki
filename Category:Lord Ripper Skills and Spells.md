## Ripper Lord Skills & Spells Chart
...
`           `[`detect`` ``haven`](detect_haven "wikilink")`              `[`send`](send "wikilink")`            `[`troika`](troika "wikilink")`      `[`dreamstalker`](Ripper_Hunting_Skills "wikilink")`*`  
`           `[`shadowhunter`](Ripper_Hunting_Skills "wikilink")`*       `[`githslayer`](Ripper_Hunting_Skills "wikilink")`*     `[`astralhunter`](Ripper_Hunting_Skills "wikilink")`*    `[`junglestalker`](Ripper_Hunting_Skills "wikilink")`*`  
`          `[`desertstalker`](Ripper_Hunting_Skills "wikilink")`*      `[`demonslayer`](Ripper_Hunting_Skills "wikilink")`*      `[`primehunter`](Ripper_Hunting_Skills "wikilink")`*      `[`reclamation`](Reclamation "wikilink")  
`250:       `[`transmogrify`](Transmogrify "wikilink")  
  
`   * `[`Lord`](:Category:_Lord "wikilink")` skills & spells that `[`Rippers`](:Category:_Rippers "wikilink")` may learn but `[`Warriors`](:Category:_Warriors "wikilink")` may not.`
