...
` 99: `  
`101: `[`backstab`](Backstab.md "wikilink")`#          `[`balance`](Balance.md "wikilink")`            `[`create`` ``food`](Create_Food.md "wikilink")`        `[`create`` ``spring`](Create_Spring.md "wikilink")`      `[`create`` ``water`](Create_Water.md "wikilink")  
`     `[`fast`` ``healing`` ``ii`](Fast_Healing_II.md "wikilink")`    `[`improved`` ``stamina`](Improved_Stamina.md "wikilink")`   `[`meditation`` ``ii`](Meditation_II.md "wikilink")`      `[`quickstrike`](Quickstrike.md "wikilink")`        `[`tutor`` ``other`](Tutor_Other.md "wikilink")  
`     `  
`500: `[`catch`` ``weapon`](Catch_Weapon.md "wikilink")`*      `[`eulogy`](Eulogy.md "wikilink")  
`     `  
`   * `[`Hero`](:Category:_Hero.md "wikilink")` skills & spells that `[`Rogues`](:Category:_Rogues.md "wikilink")` may learn but `[`Black`` ``Circle`` ``Initiates`](:Category:_Black_Circle_Initiates.md "wikilink")` may not.`  
`   # `[`Hero`](:Category:_Hero.md "wikilink")` skills & spells that `[`Rogues`](:Category:_Rogues.md "wikilink")` may learn but `[`Bladedancers`](:Category:_Bladedancers.md "wikilink")` may not.`
