...
`     `  
`  1: `[`appoint`](Appoint "wikilink")`            `[`body`` ``brace`](Body_Brace "wikilink")`         `[`butcher`](Butcher "wikilink")`            `[`kick`](Kick "wikilink")`*              `[`meditation`](Meditation "wikilink")  
...
`     `[`shadow`` ``form`](Shadow_Form "wikilink")`*       `[`word`` ``of`` ``recall`](Word_Of_Recall "wikilink")`*`  
`  7: `[`curse`](Curse "wikilink")`              `[`detect`` ``magic`](Detect_Magic "wikilink")`       `[`endurance`](Endurance "wikilink")`          `[`forage`](Forage "wikilink")`*            `[`identify`](Identify_(spell) "wikilink")  
...
` 19: `[`adrenaline`` ``pump`](Adrenaline_Pump "wikilink")`    `[`bashdoor`](Bashdoor "wikilink")`           `[`bless`](Bless "wikilink")`              `[`dart`](Dart_(spell) "wikilink")`               `[`dispel`` ``evil`](Dispel_Evil "wikilink")  
`     `[`enhanced`` ``damage`](Enhanced_Damage "wikilink")`    `[`track`](Track "wikilink")  
...
` 25: `[`cure`` ``disease`](Cure_Disease "wikilink")`       `[`displacement`](Displacement "wikilink")`       `[`double`` ``wield`](Double_Wield "wikilink")`*      `[`energy`` ``drain`](Energy_Drain "wikilink")`       `[`know`` ``alignment`](Know_Alignment "wikilink")  
...
`     `[`third`` ``attack`](Third_Attack "wikilink")`       `[`turn`` ``undead`](Turn_Undead "wikilink")  
...
` 69: `[`calm`](Calm "wikilink")`               `[`fortitudes`](Fortitudes "wikilink")`         `[`invigorate`](Invigorate "wikilink")`         `[`riposte`](Riposte "wikilink")`            `[`seal`](Seal "wikilink")`*`  
...
` 77: `  
` 79: `[`bloodhound`](Bloodhound "wikilink")`*        `[`earthquake`](Earthquake "wikilink")`         `[`foci`](Foci "wikilink")`*              `[`mass`` ``invigorate`](Mass_Invigorate "wikilink")`    `[`nexus`](Nexus "wikilink")`*`  
...
` 99: `  
`101: `[`backstab`](Backstab "wikilink")`#          `[`balance`](Balance "wikilink")`            `[`create`` ``food`](Create_Food "wikilink")`        `[`create`` ``spring`](Create_Spring "wikilink")`      `[`create`` ``water`](Create_Water "wikilink")  
`     `[`fast`` ``healing`` ``ii`](Fast_Healing_II "wikilink")`    `[`improved`` ``stamina`](Improved_Stamina "wikilink")`   `[`meditation`` ``ii`](Meditation_II "wikilink")`      `[`quickstrike`](Quickstrike "wikilink")`        `[`tutor`` ``other`](Tutor_Other "wikilink")  
`     `  
`500: `[`catch`` ``weapon`](Catch_Weapon "wikilink")`*      `[`eulogy`](Eulogy "wikilink")  
`     `  
`   * `[`Hero`](:Category:_Hero "wikilink")` skills & spells that `[`Rogues`](:Category:_Rogues "wikilink")` may learn but `[`Black`` ``Circle`` ``Initiates`](:Category:_Black_Circle_Initiates "wikilink")` may not.`  
`   # `[`Hero`](:Category:_Hero "wikilink")` skills & spells that `[`Rogues`](:Category:_Rogues "wikilink")` may learn but `[`Bladedancers`](:Category:_Bladedancers "wikilink")` may not.`

See also [Rogue Lowmort Skills &
Spells](:Category:_Rogue_Lowmort_Skills_And_Spells "wikilink"), [Black
