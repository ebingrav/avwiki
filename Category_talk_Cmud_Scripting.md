---
title: Category talk:Cmud Scripting
permalink: wiki/Category_talk:Cmud_Scripting/
layout: wiki
---
...
1\_\_j\_\_j 1\_\_j 1\_\_j\_\_j1\_\_j\\\_j} &lt;-- that line is what
fires the login' trigger. it's a line in the motd.
...
your password or this will not work. &lt;--------READ-------&gt; Also
where it says "ALTNAMEHERE" you can put in one of your nicks. The first
time you use the command "log altname" it will reset to that name. Your
