---
title: Category talk:Zmud Scripting
permalink: wiki/Category_talk:Zmud_Scripting/
layout: wiki
---
...
password or this will not work. &lt;--------READ-------&gt; Also where
it says "SCRAPE" you can put in one of your nicks. The first time you
use the command "log altname" it will reset to that name.
