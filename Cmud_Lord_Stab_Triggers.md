---
title: Cmud Lord Stab Triggers
permalink: wiki/Cmud_Lord_Stab_Triggers/
layout: wiki
tags:
 - Cmud Scripting
---
...
targets this way use | to separate eg mob1|mob2|mob3, using this method
adds to the current target list and does not replace it.
