*Tag made this collar himself from an old belt for his pet warg. The
quality is low but love has gone into it's creation. The collar has the
name 'Lucky' scratched into the leather.*

[`Armor`` ``class`](Armor_Values "wikilink")` is 2.`  
`Modifies `[`armor`` ``class`](Armor_Class "wikilink")` by -1 continuous.`

**Keyword(s):** dog, collar.  
...
**[Mob(s)](:Category:_Mobs "wikilink"):** [Warg-Like
Dog](Warg-Like_Dog "wikilink").  
See [Warg-Like Dog](Warg-Like_Dog "wikilink") for more information.
