*The youngest daughter of Matron Mother Stress, this drow priestess is
here quietly aiding her family in the defense of the house and the
survival of the city. She fingers her dagger from time to time and eyes
her sister's back.*

**Keywords:** drow, priestess, Ben'Chord.  
...
`The drow priestess is using:`  
<wielded>`           (Glowing) `[`a`` ``three-headed`` ``Snake`` ``Whip`](Three-Headed_Snake_Whip "wikilink")

`The drow priestess is carrying:`  
`     Nothing.`
...
**[Room(s)](:Category:_Rooms "wikilink"):** House Ben'Chord
(portable).  
...
The drow priestess is portable.  
