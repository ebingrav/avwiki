*This red blade is the sword favored by [Lord
Redtooth](Lord_Redtooth.md "wikilink")'s elite guards.*

[`Damage`](Melee_Weapon_Values.md "wikilink")` is 16 to 47-49 (average 31-32).`  
`Modifies `[`hit`` ``roll`](Hit_Roll.md "wikilink")` by 5 continuous.`  
`Modifies `[`damage`` ``roll`](Damage_Roll.md "wikilink")` by 8 continuous.`

**Keyword(s):** eilte, guard, guard's, sword.  
