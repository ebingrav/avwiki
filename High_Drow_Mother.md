---
title: High Drow Mother
permalink: wiki/High_Drow_Mother/
layout: wiki
tags:
 -  Mobs In Necropolis
 -  Incomplete
...
`     `[`A` `Leather` `Journal` `With` `Ripped`
`Pages`](/wiki/Leather_Journal_With_Ripped_Pages "wikilink")
...
`High Drow Mother is using:`  
<worn on body>`      `[`A` `Sea-Green`
`Dress`](/wiki/Sea-Green_Dress "wikilink")
...
`High Drow Mother is using:`  
<worn on body>`      `[`A` `Tight` `Blue`
`Gown`](/wiki/Tight_Blue_Gown "wikilink")
...
invasion](/wiki/Note_Detailing_The_Drider_Invasion "wikilink") if you give her
[a small painting](/wiki/Small_Painting "wikilink").
...
High Drow Mother [wanders](/wiki/Wandering_Mobs "wikilink").
