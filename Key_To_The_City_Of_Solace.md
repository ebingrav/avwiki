*A shiny gold city [key](:Category:Keys.md "wikilink") is here.*

**Keyword(s):** city key gold solace.  
...
This [key](:Category:_Keys.md "wikilink") unlocks the gate at the south
end of [Solace](:Category:Town_Of_Solace.md "wikilink"). The gate is
naturally open, so it isn't very useful. One could lock the gate and
confuse everyone, but that's not very nice.
