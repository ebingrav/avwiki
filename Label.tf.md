---
title: Label.tf
permalink: wiki/Label.tf/
layout: wiki
tags:
 -  TinyFugue Scripting
---

To see the results without actually labeling just use "/label
&lt;item&gt;" while not standing at Edmuntrillion the ent. When you're
confident, go to the ent and do something like "remove all.acitem" and
"/for c 1 16 /label %c.acitem" ;)  
...
-   identify now uses prompt\_exe to get rid of the /repeat... meaning
