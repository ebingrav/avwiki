...
`|   N                                               |`  
`| W + E       White Stone Rd. Area                  |`  
`|   S                                               |`  
`|               ____________   _____________        |`  
`|               ____________   _____________        |`  
`|                           | | `[`Dwarven`` ``Trade`` ``Rt.`](:Category:_Highways/Great_Wall "wikilink")`   |`  
`|            ^^^`[`Sableroix`](:Category:_Sableroix_Manor "wikilink")`^^ | |                     |`  
`|       `[`White`](:Category:_Highways/Great_Wall "wikilink")`    ^^  `[`Manor`](:Category:_Sableroix_Manor "wikilink")`  | |           ^^        |`  
`|       `[`Stone`](:Category:_Highways/Great_Wall "wikilink")`   ______:_____| ...  `[`The`` ``Weeping`](:Category:_Weeping "wikilink")`      |`  
`|       `[`Rd`](:Category:_Highways/Great_Wall "wikilink")` --> |  ___________ |                     |`  
`|              | |           :                      |`  
`|     `[`Circus`](:Category:_Circus "wikilink")` ... |    `[`Wayside`](:Category:_Wayside "wikilink")`                       |`  
`|              | |        :         ^^              |`  
`|              | |  ^^^                 Tree of     |`  
`|  `[`Stonehall`](:Category:_Stonehall "wikilink")` ... ... `[`The`](:Category:_Meadow "wikilink")`     `[`Nom`](Nom "wikilink")` * <-- Knowledge    |`  
`|              | |  `[`Meadow`](:Category:_Meadow "wikilink")`                          |`  
`|___________________________________________________|`

**Keyword(s):** map, white, stone, road.  
