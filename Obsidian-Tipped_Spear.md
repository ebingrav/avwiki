*This is a brute's weapon, originally designed for mass production
...
[`Damage`](Melee_Weapon_Values "wikilink")` is 16-20 to 49-55 (average 32-37). (estimating standard hafted weapon ranges)`  
`Modifies `[`damage`` ``roll`](Damage_Roll "wikilink")` by 14 continuous.`  
...
simultaneously  
**[Flag(s)](:Category:_Object_Flags "wikilink"):** sharp  
...
[sharpenable](Sharpen_Weapon "wikilink"). The [heavy spear,
'Ocean'](Heavy_Spear,_"Ocean" "wikilink") in contrast is 15dr/10hr
weight 24.
...
**[Mob](:Category:Mobs "wikilink")**: [Royal Half-Orc
