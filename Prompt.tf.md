...
-   prompt\_exe: instead of setting prompt\_exe to 1, you can now set it
    to a string and it'll send "PROMPT\_EXE <string>". Makes it easier
    to have multiple scripts use prompt\_exe. See the chkaff macro in
