---
title: Quest Point Catalog - Character
permalink: wiki/Quest_Point_Catalog_-_Character/
layout: wiki
tags:
 - Quest Point Catalog
---

The following character augmentations can be bought for questpoints.
...
`### Banner of the Gods: Fight with the power of the Gods! See HELP `[`BANNER`
`OF` `THE` `GODS`](/wiki/Banner_Of_The_Gods "wikilink")`.`  
