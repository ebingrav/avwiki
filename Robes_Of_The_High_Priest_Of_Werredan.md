*These fine linen robes were custom made for [the High Priest of
Werredan](High_Priest_Of_Werredan.md "wikilink"). The weave is so fine,
it almost feels like silk. They are made of purest black, with divine
symbols embroidered black on black with the occasional bit of darkest
gray.*

[`Armor`` ``Class`](Armor_Values.md "wikilink")` is 8-9.`  
`Modifies `[`save`` ``vs`` ``spell`](Saving_Throw.md "wikilink")` by -1 continuous.`  
`Modifies `[`mana`](Mana_Points.md "wikilink")` by 10 continuous.`

**Keyword(s):** priest, robes, werredan.  
...
Werredan](High_Priest_Of_Werredan.md "wikilink").  
See [the High Priest of Werredan](High_Priest_Of_Werredan.md "wikilink")
