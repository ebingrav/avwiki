*This curved blade seems impractical for combat, yet still deadly!*

[`Damage`](Melee_Weapon_Values "wikilink")` is 16 to 48 (average 32).`  
`Modifies `[`damage`` ``roll`](Damage_Roll "wikilink")` by 9 continuous.`  
`Modifies `[`hit`` ``roll`](Hit_Roll "wikilink")` by 9 continuous.`  
`Modifies `[`hit`` ``points`](Hit_Points "wikilink")` by 5 continuous.`  
`Modifies `[`mana`` ``points`](Mana_Points "wikilink")` by 5 continuous.`

**Keyword(s):** curved, sacrificial, blade.  
...
**[Mob(s)](:Category:_Mobs "wikilink"):** [Acolyte of
Bhyss](Acolyte_of_Bhyss "wikilink")  
