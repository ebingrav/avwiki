*This circlet is made of the purest silver.*

[`Armor`` ``class`](Armor_Values.md "wikilink")` is 7-10.`  
`Modifies `[`armor`` ``class`](Armor_Class.md "wikilink")` by -30 continuous.`

**Keyword(s):** silver, circlet.  
...
[Saliri](Saliri.md "wikilink"), gelatinous cube.  
See [Saliri](Saliri.md "wikilink") for more information. Gelatinous cube
is portable.
