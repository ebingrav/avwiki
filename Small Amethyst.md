*A small [gemstone](:Category:_Gemstones "wikilink") is here.*

`It has a `[`value`](Object_Worth "wikilink")` of 2000 gold coins.`

**Keyword(s):** gemstone, amethyst.  
**[Level(s)](Object_Level "wikilink"):** various.  
**[Type](:Category:_Object_Types "wikilink"):**
[gemstone](:Category:_Gemstones "wikilink").  
...
` 23-23     `[`The`` ``River`` ``Folk`](:Category:_River_Folk "wikilink")`                `[`map`](River_Folk_Map "wikilink")`       `[`River`` ``Folk`` ``Treasure`` ``Quest`](River_Folk_Treasure_Quest "wikilink")  
` 23-24     `[`Thrall`` ``Swamp`](:Category:_Thrall_Swamp "wikilink")`                  `[`map`](Thrall_Swamp_Map "wikilink")`       A Musty Cellar`
