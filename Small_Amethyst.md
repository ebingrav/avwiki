*A small [gemstone](:Category:_Gemstones.md "wikilink") is here.*

`It has a `[`value`](Object_Worth.md "wikilink")` of 2000 gold coins.`
...
` 23-23     `[`The`` ``River`` ``Folk`](:Category:_River_Folk.md "wikilink")`                `[`map`](River_Folk_Map.md "wikilink")`       `[`River`` ``Folk`` ``Treasure`` ``Quest`](River_Folk_Treasure_Quest "wikilink")  
