...
`It has a `[`value`](Object_Worth "wikilink")` of 6000 gold coins.`
...
` 05-05     `[`Catacombs`` ``of`` ``Solace`](:Category:_Catacombs_Of_Solace "wikilink")`           `[`map`](Catacombs_Of_Solace_Map "wikilink")`       `[`Old`` ``Parchment`` ``Quest`](Old_Parchment_Quest "wikilink")  
