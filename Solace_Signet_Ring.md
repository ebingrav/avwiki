*A shiny ring of obsidian is in the dirt.*

[`Armor`` ``class`](Armor_Values "wikilink")` is 3.`  
`Modifies `[`hp`](Hit_Points "wikilink")` by 4 continuous.`  
`Modifies `[`save`](Saving_Throw "wikilink")` vs spell by -2 continuous.`

**Keyword(s):** signet ring solace  
...
Arms](Sergeant_At_Arms "wikilink"), or [Captain Of The Guard
