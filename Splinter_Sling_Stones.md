*A brace of splinter [sling stones](:Category:_Stones.md "wikilink") are
lying on the ground.*
...
` 54-54     `[`Deepways`](:Category:_Deepways.md "wikilink")`                      `[`map`](Deepways_Map.md "wikilink")`       `[`Jon,`` ``the`` ``lizard`` ``hunter`` `](Jon.md "wikilink")  
...
Stones](Category:_Stones "wikilink") [Category: Splinter
