---
title: Tintin++ Auto Leveling Gear Swapper
permalink: wiki/Tintin++_Auto_Leveling_Gear_Swapper/
layout: wiki
tags:
 - TinTin++ Scripting
---
...
-   You will be wearing a [Wide Brimmed Black
    Hat](/wiki/Wide_Brimmed_Black_Hat "wikilink") as well as a [Silver
    Crucifix](/wiki/Silver_Crucifix "wikilink"), both etched *lvlgear*. This
    is a common combo of items for those characters
    [devoting](/wiki/Devotion "wikilink") [Quixoltan](Quixoltan "wikilink").
    If you do not need both items, simply remove the line in
    question below.
