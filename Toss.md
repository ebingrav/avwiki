...
After a successful toss, the first person to attack the mob will become
the mobs new target. Toss a great way to rescue at lowmort if you don't
have rescue, but can also cause problematic effects if someone were to
cast a spell or smash after a toss.

When a Monk has [Tiger Stance](Tiger_Stance "wikilink") activated, it
will hit the mob immediately after tossing it. This is handy way for a
monk to have a mob target them when they don't want to rescue (e.g. when
a Paladin is doing rescue healing).
