To obtain the [Turtle Shell Amulet](Turtle_Shell_Amulet "wikilink")
start by teleporting to [Conian](Conian_The_Hermit_Ranger "wikilink"):

-   Go s4w2s and kill the [egg-laying
    tortuga](Egg-laying_Tortuga "wikilink") and get the [unhatched
    egg](Unhatched_Egg "wikilink").
-   Go 2nwsd2e3n2ed and kill the [tortuga
    matriarch](Tortuga_Matriarch "wikilink") (aggies along the way).
...
-   Teleport to Conian and go one south to the [wise
    tortuga](Wise_Tortuga "wikilink") (or go u2w3s2wun5e). Give the
    unhatched egg to the wise tortuga for [hard fragment of tortuga
    shell](Hard_Fragment_Of_Tortuga_Shell "wikilink").
