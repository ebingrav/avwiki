*Being cast out of the city due to a sickness, this drow has joined the
ranks of these veldri and fused himself into a golem. With his disease
no longer being a problem, as well as his newfound powers, he trains for
the battle to come.*

**Keywords:** golem, veldri, warrior.  
...
`A veldri warrior is using:`  
<worn about waist>`  (Glowing) `[`an`` ``onyx`` ``belt`` ``of`` ``runes`](Onyx_Belt_Of_Runes.md "wikilink")  
<wielded>`           `[`a`` ``massive`` ``onyx`` ``cudgel`](Massive_Onyx_Cudgel.md "wikilink")

`A veldri warrior is carrying:`  
`     Nothing.`
...
**[Room(s)](:Category:_Rooms.md "wikilink"):** Veldri Training Room
