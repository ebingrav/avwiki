...
`Warrior is using:`  
<worn on body>`      `[`a`` ``travellers`` ``scalemail`](Traveller's_Scalemail "wikilink")  
<held in offhand>`   `[`a`` ``travellers`` ``shield`](Traveller's_Shield "wikilink")  
<wielded>`           `[`a`` ``travellers`` ``sword`](Traveller's_Sword "wikilink")
