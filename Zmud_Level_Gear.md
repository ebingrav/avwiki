---
title: Zmud Level Gear
permalink: wiki/Zmud_Level_Gear/
layout: wiki
tags:
 - Zmud Scripting
---
...
-   Only useful for hero runs due to the level up trigger being the
    hero line.
-   If killing mobs worth over 100 xp this trigger will not
    always trigger.
...
the [Zmud Tell Window](/wiki/Zmud_Tell_Window "wikilink") script.
