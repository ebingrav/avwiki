---
title: Zmud Tell Window
permalink: wiki/Zmud_Tell_Window/
layout: wiki
tags:
 - Zmud Scripting
---
...
Affects Drop](/wiki/Zmud_Affects_Drop "wikilink") and the [Zmud Level
Gear](/wiki/Zmud_Level_Gear "wikilink") set of triggers.

Code
----

*Copy this section and paste it into a \*.txt file. Then, in zMUD, go to
"Settings -&gt; File -&gt; Import Text" and select the file you saved
to:*
...
Drop](/wiki/Zmud_Affects_Drop "wikilink") and [Zmud Level
Gear](/wiki/Zmud_Level_Gear "wikilink") triggers which \#Echo information and
