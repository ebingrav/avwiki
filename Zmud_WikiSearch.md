---
title: Zmud WikiSearch
permalink: wiki/Zmud_WikiSearch/
layout: wiki
tags:
 -  Zmud Scripting
---
...
per wiki standards.  
![](Wikisearch.jpg "fig:Wikisearch.jpg")
...
`#ALIAS wiki {#URL http://avatar.melanarchy.info/wiki/Special:Search?search=~"%1~"} "wikisearch"`  
`#MENU {Search for '%selword' on AvatarWiki} {#URL http://avatar.melanarchy.info/wiki/Special:Search?search=~"%selword~"} "wikisearch"`  
